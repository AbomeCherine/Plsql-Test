...
## Problem Statement:
This project is a SQL-based library management system. 
It tracks books, authors, members, and borrowing records.

--------------------------------
## SQL Commands Executed:
--------------------------------
-- These lines will create new tables to our database
...
NOTE: Records have to be inserted individually
...
## Results:
- See below screenshots of the executed queries and results.
